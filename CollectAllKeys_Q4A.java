...
public class CollectAllKeys_Q4A {
    static class State {
        int x, y, keys, steps;
    ...
    public static int minimumStepsToCollectAllKeys(String[] grid) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Minimum Steps: " + minimumStepsToCollectAllKeys(grid));
    }
}
