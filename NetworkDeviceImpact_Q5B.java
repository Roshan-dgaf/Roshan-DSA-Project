 ...
 */
 ...
 public class NetworkDeviceImpact_Q5B {
     int[] disc, low;
     int time = 1;
     List<List<Integer>> bridges = new ArrayList<>();
     Map<Integer, List<Integer>> edgeMap = new HashMap<>();
 
     public List<Integer> findImpactedDevices(int numOfDevices, List<List<Integer>> connections, int targetDevice) {
         disc = new int[numOfDevices];
         low = new int[numOfDevices];
         ...
         for (List<Integer> connection : bridges) {
     ...
     public static void main(String[] args) {
         NetworkDeviceImpact_Q5B q5B = new NetworkDeviceImpact_Q5B();
         ...
         List<Integer> impactedDevices = q5B.findImpactedDevices(numOfDevices, connections, targetDevice);
